 ...
 <form method="POST"   action="/customers/{{$customer->customer_id}}">
  ...
  <div class="form-row">
    <div class="form-group col-md-4">
      ...
      <input type="text" class="form-control" id="inputName4" placeholder="Name" name="name" value="{{ $customer->name }}" >
    </div>
    <div class="form-group col-md-4">
        <label for="email">Email</label>
        <input type="email" class="form-control" id="inputEmail4" placeholder="Email" name="email"  value="{{ $customer->email }}" >
    </div>
    <div class="form-group col-md-4">
      <label for="phone">Phone</label>
      <input type="text" class="form-control" id="inputPhone4" placeholder="Phone" name="phone" value="{{ $customer->phone_number }}" >
    </div>
  </div>
